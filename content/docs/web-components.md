...
>Примечание:
>
>Данный код **не будет** работать, если вы преобразуете классы с помощью Babel. Взгляните на [проблему](https://github.com/w3c/webcomponents/issues/587) с обсуждением.
>Чтобы разрешить эту проблему добавьте [custom-elements-es5-adapter](https://github.com/webcomponents/webcomponentsjs#custom-elements-es5-adapterjs) перед загрузкой веб-компонентов.
